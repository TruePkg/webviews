...
export const FETCH_EXAMPLE = 'true-package/catalog/FETCH_EXAMPLE'
...
export default function reducer(state = new CatalogState(), action = {}) {
  if (!(state instanceof CatalogState)) return toInitialState(immutableize(state))
